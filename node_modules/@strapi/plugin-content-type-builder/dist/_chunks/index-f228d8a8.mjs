...
const ListView$1 = lazy(() => import("./ListView-8134319e.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-8134319e.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-f228d8a8.mjs.map
