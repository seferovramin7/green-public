...
export declare const selectCurrentWorkflow: ((state: Store) => Partial<Omit<Partial<Pick<import("../../../../../../../shared/contracts/review-workflows").Workflow, "id" | "contentTypes" | "name" | "stages"> & {
    permissions?: import("../../../../../../../shared/contracts/review-workflows").StagePermission[] | undefined;
}>, "stages"> & {
    stages: import("./reducer").StageWithTempKey[];
}>) & import("reselect").OutputSelectorFields<(args_0: State) => Partial<Omit<Partial<Pick<import("../../../../../../../shared/contracts/review-workflows").Workflow, "id" | "contentTypes" | "name" | "stages"> & {
    permissions?: import("../../../../../../../shared/contracts/review-workflows").StagePermission[] | undefined;
}>, "stages"> & {
    stages: import("./reducer").StageWithTempKey[];
}>, {
