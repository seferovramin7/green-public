...
const CM = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./index-3956d072.js")).then((n) => n.App).then((mod) => ({ default: mod.App }))
);
const HomePage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./HomePage-bb29ced3.js")).then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./InstalledPluginsPage-73eabc0b.js")).then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./MarketplacePage-ec91b073.js")).then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./index-3956d072.js")).then((n) => n.NotFoundPage).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./ProfilePage-a28fc7c8.js")).then((mod) => ({
    default: mod.ProfilePage
  }))
);
const SettingsPage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./SettingsPage-b5d5dd0b.js")).then((mod) => ({
...
//# sourceMappingURL=AuthenticatedApp-b186733c.js.map
