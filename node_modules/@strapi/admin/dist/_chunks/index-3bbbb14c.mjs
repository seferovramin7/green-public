...
const AuthPage = ({ hasAdmin }) => {
  ...
  const Login$1 = useEnterprise(
    Login,
    async () => (await import("./Login-6670c9b9.mjs")).LoginEE
  );
  const forms = useEnterprise(
    FORMS,
    async () => (await import("./constants-2ccf2787.mjs")).FORMS,
    {
...
const AuthenticatedApp = React.lazy(
  () => import("./AuthenticatedApp-b723bf94.mjs").then((n) => n.A).then((mod) => ({ default: mod.AuthenticatedApp }))
);
...
const EditViewPage = ({
  ...
  const Information2 = useEnterprise(
    InformationBoxCE,
    async () => (await import("./InformationBoxEE-302228b9.mjs")).InformationBoxEE
  );
  useOnce(() => {
...
const ListViewPage = ({
  ...
  const reviewWorkflowColumns = useEnterprise(
    ...
    async () => (await import("./constants-81c376c5.mjs")).REVIEW_WORKFLOW_COLUMNS_EE,
    {
  ...
  const ReviewWorkflowsColumns = useEnterprise(
    ...
    async () => {
      const { ReviewWorkflowsStageEE, ReviewWorkflowsAssigneeEE } = await import("./ReviewWorkflowsColumn-5a3ca279.mjs");
  ...
  const reviewWorkflowFilter = useEnterprise(
    ...
    async () => (await import("./constants-81c376c5.mjs")).REVIEW_WORKFLOW_FILTERS,
    {
...
//# sourceMappingURL=index-3bbbb14c.mjs.map
