...
import { n as SETTINGS_LINKS_CE, j as useEnterprise, u as useConfiguration, b as createRoute } from "./index-3bbbb14c.mjs";
...
const ROUTES_CE = [
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-96026788.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await import("./CreatePage-34ad9bdd.mjs");
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-a5a18e61.mjs");
  ...
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-57f5028e.mjs");
      return ProtectedListPage;
    },
    to: "/settings/users",
    exact: true
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-a6578110.mjs");
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await import("./CreatePage-f321dfbc.mjs");
      return ProtectedCreatePage;
    },
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-e710a231.mjs").then((n) => n.b);
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-887f0f02.mjs");
      return ProtectedListPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await import("./ListView-bf4ccdba.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await import("./CreateView-a5345794.mjs");
  ...
  {
    async Component() {
      const { ProtectedEditView } = await import("./EditViewPage-77e95780.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await import("./CreateView-df9f9bf0.mjs");
      return ProtectedCreateView;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await import("./ListView-1b370206.mjs");
      return ProtectedListView;
    },
  ...
  {
    async Component() {
      const { ProtectedEditView } = await import("./EditView-d3ccb532.mjs");
      return ProtectedEditView;
    },
...
const ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = useEnterprise(
    AdminSeatInfoCE,
    async () => (await import("./AdminSeatInfo-bb59ad1f.mjs")).AdminSeatInfoEE
  );
  const {
...
const SettingsPage = () => {
  ...
  const routes = useEnterprise(
    ROUTES_CE,
    async () => (await import("./constants-b156a1b6.mjs")).ROUTES_EE,
    {
...
//# sourceMappingURL=SettingsPage-7567e138.mjs.map
