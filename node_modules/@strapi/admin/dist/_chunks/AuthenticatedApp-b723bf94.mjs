...
import { u as useConfiguration, c as createTypedSelector, a as useOnce, b as createRoute, R as RBACProvider, N as NpsSurvey } from "./index-3bbbb14c.mjs";
...
const CM = React.lazy(
  () => import("./index-3bbbb14c.mjs").then((n) => n.A).then((mod) => ({ default: mod.App }))
);
const HomePage = React.lazy(
  () => import("./HomePage-e94a37b9.mjs").then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React.lazy(
  () => import("./InstalledPluginsPage-ff15831e.mjs").then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React.lazy(
  () => import("./MarketplacePage-54a925f9.mjs").then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React.lazy(
  () => import("./index-3bbbb14c.mjs").then((n) => n.x).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React.lazy(
  () => import("./ProfilePage-091a4db8.mjs").then((mod) => ({
    default: mod.ProfilePage
  }))
);
const SettingsPage = React.lazy(
  () => import("./SettingsPage-7567e138.mjs").then((mod) => ({
...
//# sourceMappingURL=AuthenticatedApp-b723bf94.mjs.map
