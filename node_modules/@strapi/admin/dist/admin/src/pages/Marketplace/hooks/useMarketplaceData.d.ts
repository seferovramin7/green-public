import { MarketplacePageQuery, NpmPackageType, TabQuery } from '../MarketplacePage';
...
declare function useMarketplaceData({ npmPackageType, debouncedSearch, query, tabQuery, strapiVersion, }: UseMarketplaceDataParams): {
    ...
    pluginsStatus: "error" | "success" | "loading" | "idle";
    providersStatus: "error" | "success" | "loading" | "idle";
    possibleCollections: {};
    possibleCategories: {};
    pagination: {
        page: number;
