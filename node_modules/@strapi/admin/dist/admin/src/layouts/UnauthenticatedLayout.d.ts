...
export declare const Column: import('styled-components').IStyledComponent<"web", import('styled-components/dist/types').FastOmit<Omit<Omit<import('@strapi/design-system/dist/primitives/Flex/Flex').FlexProps<"div">, "ref"> & React.RefAttributes<unknown>, "ref"> & {
