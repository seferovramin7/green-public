...
export interface ApiCareProductCareProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    isInStock: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPlacemarDetailPlacemarDetail
  extends Struct.CollectionTypeSchema {
...
export interface ApiPlacemarkPlacemark extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Name: Schema.Attribute.String;
    placemark_detail: Schema.Attribute.Relation<
      'oneToOne',
      'api::placemar-detail.placemar-detail'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPlantingProcessPlantingProcess
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    process_elements: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiProcessElementProcessElement
  extends Struct.CollectionTypeSchema {
...
export interface ApiSpecieSpecie extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    climate: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ever_green: Schema.Attribute.Boolean;
    inserted_date: Schema.Attribute.Date;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::specie.specie'
    > &
      Schema.Attribute.Private;
    long_live: Schema.Attribute.Boolean;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    sized: Schema.Attribute.Decimal;
...
export interface ApiStoreStore extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    closingAt: Schema.Attribute.Time;
    ...
    openDays: Schema.Attribute.JSON &
      ...
      >;
    openingAt: Schema.Attribute.Time;
...
export interface ApiTreeTree extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    bestSeasons: Schema.Attribute.JSON &
      Schema.Attribute.CustomField<
        'plugin::multi-select.multi-select',
    ...
    characteristic_bundle: Schema.Attribute.Relation<
      'oneToOne',
      'api::characteristic-bundle.characteristic-bundle'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    planting_process: Schema.Attribute.Relation<
      'oneToOne',
      'api::planting-process.planting-process'
    >;
    ...
    publishedAt: Schema.Attribute.DateTime;
    species: Schema.Attribute.Relation<'oneToOne', 'api::specie.specie'>;
    store: Schema.Attribute.Relation<'manyToOne', 'api::store.store'>;
    updated_date: Schema.Attribute.Date &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiWeatherWeather extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    greetingDescription: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    userType: Schema.Attribute.Enumeration<['Customer', 'Company', 'NGO']> &
